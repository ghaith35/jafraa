...
const CATEGORIES: CategoryDef[] = [
  ...
  { key: "printer_laser",     nameFr: "Imprimante Laser",         nameAr: "طابعة ليزر",      nameEn: "Laser Printer",     sortOrder: 5 },
  { key: "printer_cartridge", nameFr: "Imprimante Cartouche",     nameAr: "طابعة خرطوشة",    nameEn: "Cartridge Printer", sortOrder: 6 },
  { key: "printer_risograph", nameFr: "Imprimante Risographique", nameAr: "طابعة ريزوغراف",  nameEn: "Risograph Printer", sortOrder: 7 },
  { key: "console", nameFr: "Console de jeux",      nameAr: "جهاز ألعاب",   nameEn: "Game Console",     sortOrder: 8 },
...
const CATALOG: CategoryWithBrands[] = [
  {
    ...
    brands: [
      ...
      { name: "Itel",     sortOrder: 10, families: ["A Series", "P Series", "S Series", "Vision"] },
      ...
      { name: "Nothing",  sortOrder: 16, families: ["Phone"] },
      { name: "Sony",     sortOrder: 17, families: ["Xperia 1", "Xperia 5", "Xperia 10"] },
      { name: "Motorola", sortOrder: 18, families: ["Moto G", "Moto E", "Moto Edge", "Razr"] },
      { name: "Nokia",    sortOrder: 19, families: ["Nokia G", "Nokia C", "Nokia X"] },
      { name: "Asus",     sortOrder: 20, families: ["ROG Phone", "Zenfone"] },
  ...
  },
  {
    ...
    brands: [
      ...
      { name: "MSI",                   sortOrder: 8,  families: ["Infinite", "Trident", "MEG"] },
