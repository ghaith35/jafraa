...
export type ExpandedCatalogFamily = {
  name: string;
  models: string[];
};
...
export type ExpandedCatalogBrand = {
  name: string;
  sortOrder: number;
  families: ExpandedCatalogFamily[];
};
...
export const EXPANDED_PHONE_CATALOG: ExpandedCatalogBrand[] = [
    ...
    families: [
      ...
      },
      {
        ...
        models: [
            ...
            "Samsung Stratosphere II I415",
            "Samsung Stratosphere I405",
  ...
  },
  {
    ...
    families: [
      ...
      {
        name: "Infinix ZERO 30 Pro",
        models: [
            "Infinix ZERO 30 Pro"
          ]
      },
      {
        name: "Infinix ZERO 20 Pro",
        models: [
            "Infinix ZERO 20 Pro"
          ]
      },
