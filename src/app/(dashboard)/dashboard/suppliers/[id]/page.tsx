...
export default async function SupplierDetailPage(props: { params: Promise<{ id: string }> }) {
  ...
  const bal = supplier.balance.toNumber();
  const hasDebt = bal > 0;
    ...
    <div className="max-w-screen-xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-xl border border-border bg-card p-5 space-y-2">
            ...
            {hasDebt ? (
              <p className="text-sm text-muted-foreground">
                Vous devez ce montant à ce fournisseur.
              </p>
            ) : (
              <p className="text-sm text-muted-foreground">
        ...
        <div className="md:col-span-2 space-y-4">
          <h2 className="text-xl font-semibold tracking-tight">Historique des achats</h2>
          ...
          <div className="rounded-xl border border-dashed border-border bg-card p-10 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm font-medium text-foreground">Aucune facture d&apos;achat</p>
            <p className="mt-1 text-sm text-muted-foreground max-w-sm">
              Les factures d&apos;achat pour ce fournisseur apparaîtront ici une fois créées.
            </p>
