...
export const repairTranslations = {
  fr: {
    ...
    repairList_colTicket: "Ticket & appareil",
    repairList_colCustomer: "Client",
    repairList_colProblems: "Problèmes",
    repairList_colStatus: "Statut",
    repairList_colTechnician: "Technicien",
    repairList_colDates: "Dates",
  ...
  en: {
    ...
    repairList_colTicket: "Ticket & device",
    repairList_colCustomer: "Customer",
    repairList_colProblems: "Problems",
    repairList_colStatus: "Status",
    repairList_colTechnician: "Technician",
    repairList_colDates: "Dates",
  ...
  ar: {
    ...
    status_waiting_customer_approval: "بانتظار موافقة الزبون",
    ...
    repairList_emptyStaff: "ابدأ بإنشاء تذكرة جديدة لزبون.",
    repairList_ticketDevice: "التذكرة / الجهاز",
    repairList_technician: "التقني",
    repairList_due: "الموعد: {date}",
    repairList_colTicket: "التذكرة والجهاز",
    repairList_colCustomer: "الزبون",
    repairList_colProblems: "الأعطال",
    repairList_colStatus: "الحالة",
    repairList_colTechnician: "التقني",
    repairList_colDates: "التواريخ",

    form_unexpectedError: "حدث خطأ غير متوقع",
    form_sectionCustomer: "1. الزبون",
    form_selectCustomer: "اختر زبونًا *",
    form_chooseCustomer: "اختر زبونًا...",
    ...
    invoice_debtCreated: "سيتم تسجيل دين بقيمة {amount} DZD على حساب الزبون",
    invoice_walkinFullPayment: "زبون عابر — يجب دفع المبلغ كاملاً نقداً ({amount} DZD)",
    ...
    validation_selectCustomer: "اختر زبونًا",
    ...
    error_walkinFullCash: "يجب على الزبائن العابرين دفع المبلغ كاملاً نقداً",
