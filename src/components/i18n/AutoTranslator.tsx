...
const EXTRA_STATIC_TRANSLATIONS: Record<string, TranslationPair> = {
  ...
  "Client introuvable": { en: "Customer not found", ar: "العميل غير موجود" },
  ...
  "Commencez par créer un nouveau ticket pour un client.": { en: "Start by creating a new ticket for a customer.", ar: "ابدأ بإنشاء تذكرة جديدة لعميل." },
  ...
  "1. Client": { en: "1. Customer", ar: "1. العميل" },
  "Sélectionner un client *": { en: "Select a customer *", ar: "اختر عميلاً *" },
  "Sélectionnez un client": { en: "Select a customer", ar: "اختر عميلاً" },
  ...
  "Signature Client": { en: "Customer signature", ar: "توقيع العميل" },
  ...
  "Dette créée : {amount} DZD sera enregistrée sur le compte client": { en: "Debt created: {amount} DZD will be recorded on the customer account", ar: "تم إنشاء دين: سيتم تسجيل {amount} دج على حساب العميل" },
  "Client de passage — paiement complet en espèces requis ({amount} DZD)": { en: "Walk-in customer — full cash payment required ({amount} DZD)", ar: "عميل عابر — مطلوب دفع نقدي كامل ({amount} دج)" },
  ...
  "Les clients de passage doivent payer la totalité en espèces": { en: "Walk-in customers must pay the full amount in cash", ar: "يجب على العملاء العابرين دفع كامل المبلغ نقداً" },
  ...
  "Voulez-vous marquer ce devis comme envoyé au client ?": { en: "Do you want to mark this estimate as sent to the customer?", ar: "هل تريد وضع علامة على عرض السعر بأنه أُرسل إلى العميل؟" },
  ...
  "Devis envoyé au client, en attente d'approbation.": { en: "Estimate sent to customer, awaiting approval.", ar: "تم إرسال عرض السعر إلى العميل، بانتظار الموافقة." },
  ...
  "Client": { en: "Customer", ar: "العميل" },
  "Nouveau client": { en: "New customer", ar: "عميل جديد" },
  "Modifier le client": { en: "Edit customer", ar: "تعديل العميل" },
  "Relevé de compte client": { en: "Customer account statement", ar: "كشف حساب العميل" },
  ...
  "Un numéro de téléphone est requis pour un client nommé": { en: "A phone number is required for a named customer", ar: "رقم الهاتف مطلوب للعميل المسمى" },
  ...
  "Ce numéro est déjà associé à un autre client de cette entreprise": { en: "This number is already associated with another customer in this company", ar: "هذا الرقم مرتبط بالفعل بعميل آخر في هذه الشركة" },
  ...
  "Ce client n'a pas de dette à payer": { en: "This customer has no debt to pay", ar: "هذا العميل ليس لديه دين للدفع" },
  ...
  "Dettes Clients": { en: "Customer Debt", ar: "ديون العملاء" },
  ...
  "Total Dû par les Clients": { en: "Total due by customers", ar: "إجمالي المستحق على العملاء" },
  "Nombre de Débiteurs": { en: "Number of debtors", ar: "عدد المدينين" },
  "Risque Moyen par Client": { en: "Average risk per customer", ar: "متوسط المخاطر لكل عميل" },
...
function translateDynamicPatterns(value: string, locale: SupportedLocale) {
  ...
  if (locale === "en") {
    ...
    result = result
      .replace(/^(\d+) client(?:s)? trouvé(?:s)?$/i, (_, count) => `تم العثور على ${count} عميل`)
